...
public class Ex10_Properties {
	...
	public static void main(String[] args) {
		...
		// pp.setProperty(111, "StudentDelete.java");  -> String, String 만 허용 (컴파일오류)
		pp.put("delete", "StudentDelete.java");
		// pp.put(111, "StudentDelete.java"); // put 은  String, String 만 허용되야 하는데 JDK 11 에서는 Type이 맞지않아도 허용
		System.out.println("Properties Test");
		System.out.println(pp);
			
		// 2) 순차처리
		// => Enumeration 이용
		// => propertyNames() : properties 의 key 값들만 return
