...
public class Ex06_Shuffle {
	...
	public static void main(String[] args) {
		...
		// 2 avg 구하기
		avg =  total / (float)(t.length * t[0].length); 
		 ...
		 *
		 * 	Ex) TV 설계도(클래스)는 TV 라는 제품(객체)을 정의한   
		 * 
		 *		클래스     /     객체
		 *
		 *    제품 설계도   /     제품
		 ...
		 * 	어떤 클래스부터 만들어진 객체를 그 클래스의 인스턴스 라고 한다.
		 * 	
		 * 	Ex) TV 클래스로부터 만들어진 객체를 TV 클래스의 인스턴스라고 한다.
		 * 		결국 인스턴스는 객체와 같은 의미
		 * 
		 * 
		 * 	객체와 인스턴스의 차이점 
