...
public class New04_LocalDateTime {
	...
	public static void main(String[] args) {
		...
		// 1) 현재시간
		LocalDateTime today = LocalDateTime.of(2021, 4, 25, 11, 20);
		// 2) 항공편1의 출발 시간
		LocalDateTime flight1 = LocalDateTime.of(2021, 5, 14, 11, 15);
		// 3) 항공편2의 출발 시간
		LocalDateTime flight2 = LocalDateTime.of(2021, 5, 13, 15, 30);
