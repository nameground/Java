...
class Cati implements Animali {
	@Override
	public void breath() {
		System.out.println("고양이는 숨을 쉽니다.");
	}
	@Override
	public void sound() {
...
class Dogi implements Animali {
	@Override
	public void breath() {
		System.out.println("강아지는 숨을 쉽니다.");
	}
	@Override
	public void sound() {
	...
	@Override
	public void special() {
		System.out.println("special : 빠르게 달립니다.");
	}
}
...
class Eaglei implements Animali {
	...
	@Override
	public void sound() {
		System.out.println("수리수리 웁니다.");

	}
	@Override
	public void special() {
		System.out.println("special : 훨훨 높이 날아 다닙니다.");
	}
}
public class Ex02_AbsInterface {
	...
	public static void main(String[] args) {
		...
		// 3) 메서드 호출
		 ...
		 if(bear instanceof Animali) {
			 ...
			 System.out.println("bear 는 Animali 인스턴스가 아닙니다.");
